...
@Component({
  selector: 'app-edit-educacionn',
  templateUrl: './edit-educacionn.component.html',
  styleUrls: ['./edit-educacionn.component.css']
})
export class EditEducacionnComponent implements OnInit {
